...
if ( ! function_exists( 'rtpanel_setup' ) ) :
	...
	function rtpanel_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'rtpanel_custom_background_args', array(
...
function rtpanel_scripts() {
	...
	wp_enqueue_style( 'rtpanel-style', get_stylesheet_uri() );

	wp_enqueue_script( 'rtpanel-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'rtpanel-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	wp_enqueue_script( 'jquery', get_template_directory_uri() . '/js/jquery-3.4.1.min', array(), '3.4.1', true );
...
register_nav_menus( array(
    'primary' => __( 'Primary', 'rtpanel' ),
) );

register_nav_menus( array(
	'secondary' => esc_html__( 'Secondary', 'rtpanel' ),
) );